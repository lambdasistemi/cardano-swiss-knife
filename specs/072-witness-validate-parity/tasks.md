...
- [X] T031 Wait for fresh GitHub Actions on that pushed SHA; only after green, drop `gate.sh` in `chore: drop gate.sh (ready for review)`, mark PR #91 ready, report `COMPLETE`, and do not merge.
